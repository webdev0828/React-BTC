    ...
    constructor() {
        ...
        this.setChart = (markets, currentMarket) => {
            ...
            const widgetOptions = {
                ...
                overrides: {
                    ['symbolWatermarkProperties.color']: '#21272c',
                    ['volumePaneSize']: 'iny',
                    ...
                    ['paneProperties.background']: '#21272c',
                    ['paneProperties.vertGridProperties.color']: '#21272c',
                    ['paneProperties.vertGridProperties.style']: 1,
                    ['paneProperties.horzGridProperties.color']: '#21272c',
                    ['paneProperties.horzGridProperties.style']: 1,
                    ['paneProperties.crossHairProperties.color']: '#21272c',
                    ['paneProperties.crossHairProperties.width']: 1,
                    ['paneProperties.crossHairProperties.style']: 1,
                    ['scalesProperties.backgroundColor']: '#21272c',
                },
                loading_screen: {
