...
class MarketDepthContainer extends React.Component {
  constructor() {
    ...
    this.convertToCumulative = (data, type) => {
      ...
      const [askCurrency, bidCurrency] = [
        this.props.currentMarket.ask_unit.toUpperCase(),
        this.props.currentMarket.bid_unit.toUpperCase(),
      ]
      const tipLayout = ({
        volume,
        price,
        ...
        React.createElement(
          ...
          React.createElement(
            ...
            React.createElement(FormattedMessage, {
              id:
                'page.body.trade.header.marketDepths.content.cumulativeVolume',
            }),
            ' : ',
  ...
  shouldComponentUpdate(prev, next) {
    ...
    return (
      ordersLength !== this.props.asksItems.length + this.props.bidsItems.length
    )
  }
  render() {
...
export const MarketDepthsComponent = connect(mapStateToProps)(
