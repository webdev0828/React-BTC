        ...
        this.renderTableRow = (type, item) => {
            ...
            switch (type) {
                case 'deposits': {
                    ...
                    return [
                        React.createElement("a", { href: blockchainLink, target: "_blank", rel: "noopener noreferrer", key: txid }, txid),
                ...
                case 'withdraws': {
                    ...
                    const wallet = wallets.find(obj => obj.currency === currency);
                    return [
                        React.createElement("a", { href: blockchainLink, target: "_blank", rel: "noopener noreferrer", key: txid || rid }, txid || rid),
                        localeDate(created_at),
                        uppercase(currency),
                        wallet && preciseData(amount, wallet.fixed),
                        fee,
