                    ...
                    React.createElement("div", { className: "cr-email-form" },
                        ...
                        React.createElement("div", { className: "cr-email-form__form-content" },
                            ...
                            React.createElement("div", { className: "cr-email-form__button-wrapper" },
                                React.createElement(Button, { label: this.props.intl.formatMessage({ id: 'page.header.signIn.resetPassword.button' }), type: "submit", className: !this.disableButton() ? 'cr-email-form__button' : 'cr-email-form__button cr-email-form__button--disabled', disabled: this.disableButton(), onClick: this.handleSendNewPassword }))))))));
    }
}
