...
import { changeLanguage, logoutFetch, selectCurrentLanguage, selectCurrentMarket, selectUserInfo, selectUserLoggedIn, walletsReset, } from '../../modules';
class NavBarComponent extends React.Component {
    constructor() {
        ...
        this.getProfile = () => {
            ...
            return (React.createElement("div", { className: "pg-navbar__header-profile" },
                React.createElement(Link, { className: "pg-navbar__admin-logout", to: "/profile", onClick: this.handleRouteChange('/profile') },
                    React.createElement(FormattedMessage, { id: 'page.header.navbar.profile' })),
                React.createElement("span", null, user.email),
                React.createElement("img", { onClick: this.handleLogOut, className: "pg-navbar__header-profile-logout", src: require(`./logout.svg`) })));
        };
        this.getLanguageMenu = () => {
            return (React.createElement("div", { className: "dropdown-menu dropdown-menu-language", role: "menu" },
                ...
                React.createElement("div", { className: "dropdown-menu-item-lang", onClick: e => this.handleChangeLanguage('zh') }, "\u4E2D\u56FD")));
        };
        this.getUserEmailMenu = () => {
            ...
            return (React.createElement("div", { className: "btn-group pg-navbar__header-settings__account-dropdown dropdown-toggle" },
                React.createElement("div", { onClick: this.openMenu, className: userClassName },
                    React.createElement("img", { src: require(`./${isOpen ? 'open' : 'close'}-avatar.svg`) }),
        ...
        this.getUserMenu = () => {
            return (React.createElement("div", { className: "dropdown-menu dropdown-menu-user", role: "menu" },
                React.createElement("div", { className: "dropdown-menu-item-user" },
                    React.createElement(Link, { className: "pg-navbar__admin-logout", to: "/profile", onClick: this.handleRouteChange('/profile') },
                        React.createElement(FormattedMessage, { id: 'page.header.navbar.profile' }))),
                React.createElement("div", { className: "dropdown-menu-item-user" },
                    React.createElement("a", { className: "pg-navbar__admin-logout", onClick: this.handleLogOut },
    ...
    render() {
        ...
        return (React.createElement("div", { className: 'pg-navbar' },
            user.email ? this.getProfile() : null,
            React.createElement("ul", { className: "pg-navbar__content" }, pgRoutes(!!user.email).map(this.navItem(address, this.props.onLinkChange))),
            React.createElement("div", { className: "pg-navbar__header-settings" },
                user.email ? this.getUserEmailMenu() : null,
                React.createElement("div", { className: "btn-group pg-navbar__header-settings__account-dropdown dropdown-toggle dropdown-menu-language-container" },
            ...
            React.createElement("div", { className: "pg-navbar__header-language", onClick: this.toggleLanguageMenu },
